...
### PM
- `pm` — Orchestrator — `openrouter/deepseek/deepseek-v4-pro` — `/home/samurai/openclaw/workspace-pm`

### Prog
- `prog-impl-a` — Implementer — `openrouter/qwen/qwen3-coder-flash` — `/home/samurai/openclaw/workspace-prog-impl`
- `prog-impl-b` — Implementer — `openrouter/deepseek/deepseek-v4-flash` — `/home/samurai/openclaw/workspace-prog-impl`
- `prog-val-a` — Validator — `openrouter/deepseek/deepseek-v4-pro` — `/home/samurai/openclaw/workspace-prog-val`
- `prog-val-b` — Validator — `openrouter/z-ai/glm-5.1` — `/home/samurai/openclaw/workspace-prog-val`

### Infra
- `infra-impl-a` — Implementer — `openrouter/qwen/qwen3-coder-flash` — `/home/samurai/openclaw/workspace-infra-impl`
- `infra-impl-b` — Implementer — `openrouter/deepseek/deepseek-v4-flash` — `/home/samurai/openclaw/workspace-infra-impl`
- `infra-val-a` — Validator — `openrouter/deepseek/deepseek-v4-pro` — `/home/samurai/openclaw/workspace-infra-val`
- `infra-val-b` — Validator — `openrouter/z-ai/glm-5.1` — `/home/samurai/openclaw/workspace-infra-val`

### SLR — Harvest
- `harvest-impl-a` — Implementer — `openrouter/qwen/qwen3-coder-flash` — `/home/samurai/openclaw/workspace-slr-harvest`
- `harvest-val-b` — Validator — `openrouter/z-ai/glm-5.1` — `/home/samurai/openclaw/workspace-slr-harvest`

### SLR — Screen
- `screen-impl-b` — Implementer — `openrouter/deepseek/deepseek-v4-flash` — `/home/samurai/openclaw/workspace-slr-screen`
- `screen-val-a` — Validator — `openrouter/deepseek/deepseek-v4-pro` — `/home/samurai/openclaw/workspace-slr-screen`

### SLR — Extract
- `extract-impl-a` — Implementer — `openrouter/qwen/qwen3-coder-flash` — `/home/samurai/openclaw/workspace-slr-extract`
- `extract-val-b` — Validator — `openrouter/z-ai/glm-5.1` — `/home/samurai/openclaw/workspace-slr-extract`

### SLR — Synth
- `synth-impl-b` — Implementer — `openrouter/deepseek/deepseek-v4-flash` — `/home/samurai/openclaw/workspace-slr-synth`
- `synth-val-a` — Validator — `openrouter/deepseek/deepseek-v4-pro` — `/home/samurai/openclaw/workspace-slr-synth`

### SLR — Prisma
- `prisma-impl-b` — Implementer — `openrouter/deepseek/deepseek-v4-flash` — `/home/samurai/openclaw/workspace-slr-prisma`
- `prisma-val-a` — Validator — `openrouter/deepseek/deepseek-v4-pro` — `/home/samurai/openclaw/workspace-slr-prisma`

Notes:

- PM remains in contingency mode on `openrouter/deepseek/deepseek-v4-pro`.
