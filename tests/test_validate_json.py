...
class TestLoadJsonFile:
    ...
    def test_load_json_without_metadata(self, tmp_path):
        ...
        data = [{"id": "1", "title": "Record 1"}, {"id": "2", "title": "Record 2"}]
    ...
    def test_utf8_encoding(self, tmp_path):
        ...
        data = [{"id": "1", "title": "Testação Françai§ 中文"}]
...
class TestValidateAppendix:
    ...
    def test_validate_valid_appendix(self, tmp_path):
        ...
        data = [{"_meta": True, "version": "1.0"}, {"id": "1", "title": "Test"}]
        ...
        is_valid, count, errors = validate_appendix(
            "Test Appendix", json_file, schema_file
        )
    ...
    def test_validate_file_not_found(self, tmp_path):
        ...
        is_valid, count, errors = validate_appendix("Test", missing_file, schema_file)
    ...
    def test_validate_invalid_json(self, tmp_path):
        ...
        is_valid, count, errors = validate_appendix("Test", json_file, schema_file)
...
class TestGenerateReport:
    ...
    def test_generate_report_all_valid(self):
        ...
        results = {"Appendix A": (True, 100, []), "Appendix B": (True, 50, [])}
    ...
    def test_generate_report_with_errors(self):
        ...
        results = {"Appendix A": (False, 10, ["Error 1", "Error 2"])}
    ...
    def test_generate_report_truncates_long_error_list(self):
        ...
        results = {"Appendix A": (False, 20, errors)}
...
class TestMain:
    ...
    def test_main_validates_all_appendices(self, tmp_path, monkeypatch):
        ...
        report_files = list(
            (tmp_path / "validation_reports").glob("*_validation_report.md")
        )
...
class TestIntegration:
    ...
    def test_full_validation_workflow(self, tmp_path):
        ...
        data = [
            {"_meta": True, "protocol_version": "ELIS 2025", "record_count": 2},
            {
        ...
        # Run validation
        is_valid, count, errors = validate_appendix(
            "Integration Test", json_file, schema_file
        )
