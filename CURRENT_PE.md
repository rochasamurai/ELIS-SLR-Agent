...
| PM-CHORE-38  | Adopted `ELIS_MultiAgent_Implementation_Plan_v1_8_3.md` as a patch revision to v1.8.2 while keeping PE-INFRA-SLR-01 active. Added `PE-INFRA-SLR-03` (PM Control-Plane Dispatch Hardening) to implement six orchestration reliability improvements: cross-agent visibility, direct PM dispatch with ACK contract, reachability/heartbeat gate, command contract, automatic runner fallback, and auditable event trail. | 2026-04-14 |
