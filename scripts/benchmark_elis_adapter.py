...
class BenchmarkElisAdapter:
    ...
    def execute_search(self) -> pd.DataFrame:
        ...
        print(f"   Period: {self.config['search_parameters']['date_range']['start']} to {self.config['search_parameters']['date_range']['end']}")
        print(f"   Databases: {', '.join(self.config['search_parameters']['databases'])}")
